...
public class OperatorViewModel extends BaseViewModel<OperatorNavigator> {

    public OperatorViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
