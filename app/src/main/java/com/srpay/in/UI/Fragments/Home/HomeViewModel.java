...
public class HomeViewModel extends BaseViewModel<HomeNavigator> {
    ...
    public void goToPrepaid()
    {
        ...
        intent.putExtra(RechargeConfig.TYPE,RechargeConfig.Type.PREPAID.toString());
        getNavigator().goToRecharge(intent);
    }

    public void goToPostpaid()
    {
        Intent intent = new Intent();
        intent.putExtra(RechargeConfig.TYPE,RechargeConfig.Type.POSTPAID.toString());
        getNavigator().goToBillPay(intent);
    }
